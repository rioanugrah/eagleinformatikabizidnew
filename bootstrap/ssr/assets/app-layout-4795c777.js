...
function MenuAdministrator() {
  ...
  return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("ul", { role: "list", className: "-mx-2 space-y-1", children: [
    /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(Link, { href: route("dashboard.admin"), className: classNames(route().current("dashboard.admin") ? "bg-gray-50 text-indigo-600" : "text-gray-700 hover:bg-gray-50 hover:text-indigo-600", "group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6"), children: [
    ...
    /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(Link, { href: route("categories.index"), className: classNames(route().current("categories.index*") ? "bg-gray-50 text-indigo-600" : "text-gray-700 hover:bg-gray-50 hover:text-indigo-600", "group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6"), children: [
      /* @__PURE__ */ jsx(Icon, { icon: "IconChartPie3" }),
      "Category"
    ] }) }),
    ...
    /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(Link, { href: "#", className: classNames(route().current("billings*") ? "bg-gray-50 text-indigo-600" : "text-gray-700 hover:bg-gray-50 hover:text-indigo-600", "group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6"), children: [
      /* @__PURE__ */ jsx(Icon, { icon: "IconChartPie3" }),
      "Billing"
    ] }) }),
    /* @__PURE__ */ jsx(Separator, { className: "!my-4" }),
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(Dialog, { open, onClose: setOpen, className: "relative z-50 lg:hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "fixed inset-0 flex", children: /* @__PURE__ */ jsxs(Dialog.Panel, { transition: true, className: "relative mr-16 flex w-full max-w-xs flex-1 transform transition duration-300 ease-in-out data-[closed]:-translate-x-full", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4", children: [
          /* @__PURE__ */ jsx("div", { className: "flex h-16 shrink-0 items-center", children: /* @__PURE__ */ jsx("img", { alt: "Eagle Media Informatika", src: logo, className: "h-8 w-auto" }) }),
          /* @__PURE__ */ jsx("nav", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ jsx("ul", { role: "list", className: "flex flex-1 flex-col gap-y-7", children: /* @__PURE__ */ jsx(MenuAdministrator, {}) }) })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col", children: /* @__PURE__ */ jsxs("div", { className: "flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4", children: [
      ...
      /* @__PURE__ */ jsx("nav", { className: "flex flex-1 flex-col", children: /* @__PURE__ */ jsxs("ul", { role: "list", className: "flex flex-1 flex-col gap-y-7", children: [
        /* @__PURE__ */ jsx(MenuAdministrator, {}),

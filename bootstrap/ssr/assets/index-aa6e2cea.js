    ...
    /* @__PURE__ */ jsxs(CardContent, { children: [
      ...
      /* @__PURE__ */ jsxs(Table, { children: [
        /* @__PURE__ */ jsx(TableHeader, { children: /* @__PURE__ */ jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsx(TableHead, { onClick: () => handleSort("created_at"), children: /* @__PURE__ */ jsx(SortIndicator, { label: "Date Create", column: "created_at", field: params == null ? void 0 : params.field, direction: params == null ? void 0 : params.direction }) }),
        ...
        /* @__PURE__ */ jsx(TableBody, { children: transactions.length > 0 ? /* @__PURE__ */ jsx(Fragment, { children: transactions.map((transaction, i) => /* @__PURE__ */ jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsx(TableCell, { className: "text-right", children: transaction.total }),
          /* @__PURE__ */ jsx(TableCell, { className: "text-center", children: transaction.created_at }),
          /* @__PURE__ */ jsx(TableCell, { className: "text-center", children: transaction.status == "PAID" ? /* @__PURE__ */ jsx("span", { className: "me-2 rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-300", children: transaction.status }) : transaction.status == "UNPAID" ? /* @__PURE__ */ jsx("span", { className: "bg-yellow-100 text-yellow-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm dark:bg-yellow-900 dark:text-yellow-300", children: transaction.status }) : /* @__PURE__ */ jsx("span", { className: "bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm dark:bg-red-900 dark:text-red-300", children: transaction.status }) }),
          /* @__PURE__ */ jsxs(TableCell, { children: [
            /* @__PURE__ */ jsxs(Link, { href: route("order.detail", [transaction.order_id]), className: "items-center inline-flex text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2", children: [
...
Index.layout = (page) => /* @__PURE__ */ jsx(Index$1, { title: "Transaction", children: page });
export {
  Index as default
};

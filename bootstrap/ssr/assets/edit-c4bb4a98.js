...
function Edit(props) {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Edit Category" }) }),
...
Edit.layout = (page) => /* @__PURE__ */ jsx(AppLayout, { title: "Edit Category", children: page });
export {
  Edit as default
};

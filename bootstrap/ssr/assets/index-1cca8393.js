    ...
    /* @__PURE__ */ jsxs(CardContent, { children: [
      ...
      /* @__PURE__ */ jsxs(Table, { children: [
        ...
        /* @__PURE__ */ jsx(TableBody, { children: invoices.length > 0 ? /* @__PURE__ */ jsx(Fragment, { children: invoices.map((invoice, i) => /* @__PURE__ */ jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsx(TableCell, { children: invoice.status == "PAID" ? /* @__PURE__ */ jsx("span", { class: "me-2 rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-300", children: invoice.status }) : invoice.status == "OPEN" ? /* @__PURE__ */ jsx("span", { class: "bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300", children: invoice.status }) : invoice.status == "UNPAID" ? /* @__PURE__ */ jsx("span", { class: "bg-yellow-100 text-yellow-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300", children: invoice.status }) : /* @__PURE__ */ jsx("span", { class: "me-2 rounded bg-red-100 px-2.5 py-0.5 text-xs font-medium text-red-800 dark:bg-red-900 dark:text-red-300", children: invoice.status }) }),
          /* @__PURE__ */ jsx(TableCell, { children: invoice.status == "OPEN" ? /* @__PURE__ */ jsxs(Link, { href: route("order.checkout", [invoice.id]), className: "inline-flex items-center text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2", children: [
            /* @__PURE__ */ jsx(Icon, { icon: "IconShoppingCartUp" }),
            " Detail Cart"
          ] }) : invoice.status == "UNPAID" ? /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(Link, { href: route("invoices.detail", [invoice.id]), className: "inline-flex items-center text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2", children: [
            /* @__PURE__ */ jsx(Icon, { icon: "IconFileInvoice" }),
            " Invoices"
          ] }) }) : /* @__PURE__ */ jsxs(Link, { href: route("invoices.detail", [invoice.id]), className: "inline-flex items-center text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2", children: [
            /* @__PURE__ */ jsx(Icon, { icon: "IconShoppingCartUp" }),
            " Detail Cart"
          ] }) })

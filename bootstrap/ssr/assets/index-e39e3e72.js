...
import { A as AppLayout } from "./app-layout-4795c777.js";
  ...
  return /* @__PURE__ */ jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsxs(CardContent, { children: [
      ...
      /* @__PURE__ */ jsxs(Table, { children: [
        ...
        /* @__PURE__ */ jsx(TableBody, { children: categories.length > 0 ? /* @__PURE__ */ jsx(Fragment, { children: categories.map((category, i) => /* @__PURE__ */ jsxs(TableRow, { children: [
          /* @__PURE__ */ jsx(TableCell, { className: "w-0 py-7 text-center", children: meta.from + i }),
          /* @__PURE__ */ jsx(TableCell, { children: category.name }),
          /* @__PURE__ */ jsx(TableCell, { children: category.status == "Aktif" ? /* @__PURE__ */ jsx("span", { class: "me-2 rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-300", children: category.status }) : /* @__PURE__ */ jsx("span", { class: "me-2 rounded bg-red-100 px-2.5 py-0.5 text-xs font-medium text-red-800 dark:bg-red-900 dark:text-red-300", children: category.status }) }),
          /* @__PURE__ */ jsxs(TableCell, { children: [
            /* @__PURE__ */ jsxs(Link, { href: route("categories.edit", [category.id]), className: "mb-2 me-2 inline-flex items-center rounded-lg bg-gradient-to-r from-lime-200 via-lime-400 to-lime-500 px-5 py-2.5 text-center text-sm font-medium text-gray-900 shadow-lg shadow-lime-500/50 hover:bg-gradient-to-br focus:outline-none focus:ring-4 focus:ring-lime-300 dark:shadow-lg dark:shadow-lime-800/80 dark:focus:ring-lime-800", children: [
              /* @__PURE__ */ jsx(Icon, { icon: "IconLogin2" }),
              " Edit"
            ] }),
            /* @__PURE__ */ jsxs(Link, { as: "button", method: "delete", href: route("categories.destroy", [category.id]), className: "mb-2 mb-2 me-2 me-2 inline-flex rounded-lg bg-gradient-to-r from-red-400 via-red-500 to-red-600 px-5 py-2.5 text-center text-sm font-medium text-white shadow-lg shadow-red-500/50 hover:bg-gradient-to-br focus:outline-none focus:ring-4 focus:ring-red-300 dark:shadow-lg dark:shadow-red-800/80 dark:focus:ring-red-800", children: [
              /* @__PURE__ */ jsx(Icon, { icon: "IconTrash" }),
              " Delete"
            ] })
          ] })
        ] }, i)) }) : /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: 4, className: "animate-pulse py-5 text-center text-base font-semibold text-destructive", children: "No Categories." }) }) })
      ] })
    ] }),
...
Index.layout = (page) => /* @__PURE__ */ jsx(AppLayout, { title: "Categories", children: page });
export {
  Index as default
};

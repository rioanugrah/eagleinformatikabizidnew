...
function AboutUs() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Tentang Kami" }),
    ...
    /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-between pb-16 pt-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "hover-up-5 wow animate__ animate__fadeInUp animated flex w-1/2 py-4 lg:w-auto", "data-wow-delay": ".2s", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "ml-2 sm:ml-6 sm:py-2", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "font-heading count font-bold sm:text-2xl", children: "150" }),
          /* @__PURE__ */ jsx("p", { className: "text-blueGray-400 text-xs sm:text-base", children: "Annual Partner" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "hover-up-5 wow animate__ animate__fadeInUp animated flex w-1/2 py-4 lg:w-auto", "data-wow-delay": ".2s", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "ml-2 sm:ml-6 sm:py-2", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "font-heading font-bold sm:text-2xl", children: " k " }),
          /* @__PURE__ */ jsx("p", { className: "text-blueGray-400 text-xs sm:text-base", children: "Completed Projects" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "hover-up-5 wow animate__ animate__fadeInUp animated flex w-1/2 py-4 lg:w-auto", "data-wow-delay": ".2s", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "ml-2 sm:ml-6 sm:py-2", children: [
          /* @__PURE__ */ jsx("span", { className: "font-heading font-bold sm:text-2xl", children: "+ " }),
          /* @__PURE__ */ jsx("span", { className: "font-heading count font-bold sm:text-2xl", children: "500" }),
          /* @__PURE__ */ jsx("p", { className: "text-blueGray-400 text-xs sm:text-base", children: "Happy Customers" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "hover-up-5 wow animate__ animate__fadeInUp animated flex w-1/2 py-4 lg:w-auto", "data-wow-delay": ".2s", children: [
        ...
        /* @__PURE__ */ jsxs("div", { class: "ml-2 sm:ml-6 sm:py-2", children: [
          ...
          /* @__PURE__ */ jsx("p", { class: "text-blueGray-400 text-xs sm:text-base", children: "Research Work" })
        ] })
      ] })
    ] }) })
  ] });

      ...
      /* @__PURE__ */ jsxs(CardContent, { children: [
        ...
        /* @__PURE__ */ jsxs(Table, { children: [
          /* @__PURE__ */ jsx(TableHeader, { children: /* @__PURE__ */ jsxs(TableRow, { children: [
            ...
            /* @__PURE__ */ jsx(TableHead, { onClick: () => handleSort("action"), children: "Action" }),
            /* @__PURE__ */ jsx(TableHead, { onClick: () => handleSort("picture"), children: /* @__PURE__ */ jsx(SortIndicator, { label: "Picture", column: "picture", field: params == null ? void 0 : params.field, direction: params == null ? void 0 : params.direction }) }),
            ...
            /* @__PURE__ */ jsx(TableHead, { onClick: () => handleSort("title"), children: /* @__PURE__ */ jsx(SortIndicator, { label: "Title", column: "title", field: params == null ? void 0 : params.field, direction: params == null ? void 0 : params.direction }) }),
            /* @__PURE__ */ jsx(TableHead, { onClick: () => handleSort("category_id"), children: /* @__PURE__ */ jsx(SortIndicator, { label: "Category", column: "category_id", field: params == null ? void 0 : params.field, direction: params == null ? void 0 : params.direction }) }),
            /* @__PURE__ */ jsx(TableHead, { onClick: () => handleSort("price"), children: /* @__PURE__ */ jsx(SortIndicator, { label: "Price", column: "price", field: params == null ? void 0 : params.field, direction: params == null ? void 0 : params.direction }) }),
            /* @__PURE__ */ jsx(TableHead, { onClick: () => handleSort("quantity"), children: /* @__PURE__ */ jsx(SortIndicator, { label: "Quantity", column: "quantity", field: params == null ? void 0 : params.field, direction: params == null ? void 0 : params.direction }) }),
          ...
          /* @__PURE__ */ jsx(TableBody, { children: products.length > 0 ? /* @__PURE__ */ jsx(Fragment, { children: products.map((product, i) => /* @__PURE__ */ jsxs(TableRow, { children: [
            ...
            /* @__PURE__ */ jsxs(TableCell, { children: [
              /* @__PURE__ */ jsxs(Link, { as: "button", method: "post", href: route("cart.add", [product.id]), className: "mb-2 me-2 inline-flex items-center rounded-lg bg-gradient-to-r from-green-400 via-green-500 to-green-600 px-5 py-2.5 text-center text-sm font-medium text-white shadow-lg shadow-green-500/50 hover:bg-gradient-to-br focus:outline-none focus:ring-4 focus:ring-green-300 dark:shadow-lg dark:shadow-green-800/80 dark:focus:ring-green-800", children: [
                /* @__PURE__ */ jsx(Icon, { icon: "IconShoppingCartPlus", className: "w-6 h-6 me-2" }),
                " Add Cart"
              ] }),
              /* @__PURE__ */ jsxs(Link, { href: route("products.detail", [product.id]), className: "mb-2 me-2 inline-flex items-center text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center", children: [
                /* @__PURE__ */ jsx(Icon, { icon: "IconEye", className: "w-6 h-6 me-2" }),
                " View"
              ] }),
              auth.user.access == true && /* @__PURE__ */ jsxs(Fragment, { children: [
                ...
                /* @__PURE__ */ jsxs(Link, { as: "button", method: "delete", href: route("products.destroy", [product.id]), className: "mb-2 mb-2 me-2 me-2 inline-flex items-center rounded-lg bg-gradient-to-r from-red-400 via-red-500 to-red-600 px-5 py-2.5 text-center text-sm font-medium text-white shadow-lg shadow-red-500/50 hover:bg-gradient-to-br focus:outline-none focus:ring-4 focus:ring-red-300 dark:shadow-lg dark:shadow-red-800/80 dark:focus:ring-red-800", children: [
                  /* @__PURE__ */ jsx(Icon, { icon: "IconTrash", className: "w-6 h-6 me-2" }),
                  " Delete"
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx("img", { src: product.picture, className: "h-auto max-w-lg rounded-lg", width: 220 }) }),
            /* @__PURE__ */ jsx(TableCell, { children: product.product_code }),
            /* @__PURE__ */ jsx(TableCell, { children: product.title }),
            /* @__PURE__ */ jsx(TableCell, { children: product.category_id }),
            /* @__PURE__ */ jsx(TableCell, { children: product.price }),
            /* @__PURE__ */ jsx(TableCell, { children: product.quantity }),

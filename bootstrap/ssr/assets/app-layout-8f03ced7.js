...
function MenuAdministrator() {
  ...
  return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("ul", { role: "list", className: "-mx-2 space-y-1", children: [
    /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(Link, { href: route("dashboard.admin"), className: classNames(route().current("dashboard") ? "bg-gray-50 text-indigo-600" : "text-gray-700 hover:bg-gray-50 hover:text-indigo-600", "group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6"), children: [

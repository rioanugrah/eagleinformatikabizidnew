...
import { l as logo } from "./LogoSubEagleMediaInformatika-b47f6c73.js";
...
function MenuUser() {
  ...
  return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("ul", { role: "list", className: "-mx-2 space-y-1", children: [
    ...
    /* @__PURE__ */ jsx(Separator, { className: "!my-4" }),
    /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(Link, { href: route("transaction"), className: classNames(route().current("transaction*") ? "bg-gray-50 text-indigo-600" : "text-gray-700 hover:bg-gray-50 hover:text-indigo-600", "group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6"), children: [
      /* @__PURE__ */ jsx(Icon, { icon: "IconChartPie3" }),
      "Transactions"
    ] }) }),
    /* @__PURE__ */ jsx(Separator, { className: "!my-4" }),
    ...
    /* @__PURE__ */ jsxs(Dialog, { open, onClose: setOpen, className: "relative z-50 lg:hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "fixed inset-0 flex", children: /* @__PURE__ */ jsxs(DialogPanel, { transition: true, className: "relative mr-16 flex w-full max-w-xs flex-1 transform transition duration-300 ease-in-out data-[closed]:-translate-x-full", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4", children: [
          /* @__PURE__ */ jsx("div", { className: "flex h-18 shrink-0 items-center", children: /* @__PURE__ */ jsx("img", { alt: "Eagle Media Informatika", src: logo, width: "180" }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "lg:pl-72", children: [
      /* @__PURE__ */ jsx("div", { className: "sticky top-0 z-40 lg:mx-auto lg:max-w-7xl lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "flex h-16 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-0 lg:shadow-none", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex flex-1 gap-x-4 self-stretch lg:gap-x-6", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-4 lg:gap-x-6", children: [
          /* @__PURE__ */ jsxs(Link, { href: dataCart.url, className: "relative rounded-full border-2 border-transparent px-1 py-4 text-gray-800 transition duration-150 ease-in-out hover:text-gray-400 focus:text-gray-500 focus:outline-none", "aria-label": "Cart", children: [
            /* @__PURE__ */ jsx(Icon, { icon: "IconShoppingCart" }),
            /* @__PURE__ */ jsx("span", { className: "absolute inset-0 -mr-6 object-right-top", children: /* @__PURE__ */ jsx("div", { className: "inline-flex items-center rounded-full border-2 border-white bg-red-500 px-1.5 py-0.5 text-xs font-semibold leading-4 text-white", children: dataCart.total_cart }) })
          ] }),
          /* @__PURE__ */ jsxs("button", { type: "button", className: "relative rounded-full border-2 border-transparent px-1 py-4 text-gray-800 transition duration-150 ease-in-out hover:text-gray-400 focus:text-gray-500 focus:outline-none", "aria-label": "Cart", children: [
            /* @__PURE__ */ jsx(Icon, { icon: "IconBell" }),
            /* @__PURE__ */ jsx("span", { className: "absolute inset-0 -mr-6 object-right-top", children: /* @__PURE__ */ jsx("div", { className: "inline-flex items-center rounded-full border-2 border-white bg-red-500 px-1.5 py-0.5 text-xs font-semibold leading-4 text-white", children: "0" }) })
          ] }),

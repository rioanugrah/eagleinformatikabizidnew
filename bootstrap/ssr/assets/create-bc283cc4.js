...
function Create() {
  ...
  const [ppn_name, setPpnName] = useState("");
  const [ppn_nominal, setPpnNominal] = useState("");
  const [ppn_status, setPpnStatus] = useState("");
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Create PPN" }) }),
...
Create.layout = (page) => /* @__PURE__ */ jsx(AppLayout, { title: "Create PPN", children: page });
export {
  Create as default
};

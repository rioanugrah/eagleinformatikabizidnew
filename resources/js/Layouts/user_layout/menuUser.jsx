    ...
    return (
        <li>
            <ul role='list' className='-mx-2 space-y-1'>
                ...
                <li>
                    <Link href={route('billing.index')} className={classNames(route().current('billing*') ? 'bg-gray-50 text-indigo-600' : 'text-gray-700 hover:bg-gray-50 hover:text-indigo-600', 'group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6')}>
                        <Icon icon={'IconChartPie3'} />
                        Billing
                    </Link>
                </li>

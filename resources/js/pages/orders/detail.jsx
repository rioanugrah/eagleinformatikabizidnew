    ...
    return(
        ...
        />
            <div className='px-4 sm:px-0'>
                <h3 className='text-base/7 font-semibold text-gray-900'>Order Code : #{order.order_code}</h3>
            ...
            <div className='mt-6 border-t border-gray-100'>
                ...
                <dl className='divide-y divide-gray-100'>
                    ...
                    <div className='px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0'>
                        ...
                        <dd className='mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0'>{format_currency(order.tax)}</dd>
                    </div>
                    <div className='px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0'>

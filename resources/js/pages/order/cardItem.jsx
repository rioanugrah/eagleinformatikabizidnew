...
export default function CardItem({ id, item, quantity, amount, updateQty }) {
        ...
        <li className='flex px-4 py-6 sm:px-6'>
            <div className='ml-6 flex flex-1 flex-col'>
                <div className='flex'>
                    <div className='min-w-0 flex-1'>
                        <h4 className='text-sm'>
                            <a className='font-bold text-gray-700 hover:text-gray-800'>{item.split('|')[1]}</a>
                        </h4>
                    </div>
                ...
                <div className='flex flex-1 items-end justify-between pt-2'>
                    <p className='mt-1 text-sm font-medium text-gray-900'>{format_currency(amount)}</p>

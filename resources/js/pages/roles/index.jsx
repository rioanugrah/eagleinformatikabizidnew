                                ...
                                <>
                                    {roles.map((item, i) => (
                                        <TableRow key={i}>
                                            ...
                                            <TableCell>
                                                {/* <Link href={route('roles.make_access',[item.id])} class='focus:outline-none text-white bg-blue-400 hover:bg-blue-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-blue-900'>
                                                    Make Access
                                                </Link> */}
                                                <Link href={route('roles.edit',[item.id])} class='focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900'>
                                                    Edit
                                                </Link>
                                                <Link
...
Index.layout = (page) => <AppLayout title={'Roles'} children={page} />;
